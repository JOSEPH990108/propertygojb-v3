...
import { resolveLeadRowView } from "@/lib/admin/lead-inquiry-view";
...
export default async function AdminLeadsPage({
  ...
  return (
    <main id="main-content" className="space-y-8 p-4 sm:p-6 lg:p-8">
      ...
      <section className="space-y-4 sm:hidden">
        {inquiries.length === 0 ? (
          ...
          inquiries.map((inquiry) => {
            const { projectName, customerName, phone, email, whatsappHref } =
              resolveLeadRowView(inquiry);
            ...
            return (
              ...
              >
                <div className="flex items-start justify-between gap-3">
                  <div className="min-w-0">
                    <Link
                      ...
                      className="block truncate font-black text-slate-950 hover:text-blue-700 hover:underline"
                    >
                      {customerName}
                    </Link>
                ...
                <div className="mt-3 space-y-1 text-xs font-semibold text-slate-500">
                  ...
                  <p>{formatDate(inquiry.receivedAt)}</p>
                </div>
      ...
      <section className="hidden overflow-hidden rounded-[2rem] border border-slate-200 bg-white shadow-sm sm:block">
        <div
          role="region"
