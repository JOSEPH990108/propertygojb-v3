    ...
    <div className="space-y-8 p-8">
        ...
        <div className="flex flex-col gap-5 lg:flex-row lg:items-start lg:justify-between">
          <div>
            ...
            <p className="mt-2 max-w-2xl text-sm leading-6 text-slate-500">
              Track your assigned customer bookings, linked projects, selected
              units, payment stage, and approval progress.
            </p>
          </div>
          ...
          <form className="flex w-full max-w-md items-center gap-2 rounded-2xl border border-slate-200 bg-slate-50 px-3 py-2">
            ...
            <input
              name="q"
              defaultValue={search}
              placeholder="Search booking, customer, project..."
      ...
      <section className="grid gap-4 md:grid-cols-2 xl:grid-cols-4">
        <MetricCard
          ...
          description={
            canSeeAll
              ? "Super Admin development view shows all bookings."
              : "Bookings assigned to your agent account."
          }
          tone="info"
        />
        <MetricCard
