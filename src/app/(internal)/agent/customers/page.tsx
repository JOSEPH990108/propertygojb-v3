...
export default async function AgentCustomersPage({
  ...
  const customers = await db
    .select({
      ...
      assigneeUserId: schema.leads.currentAssigneeUserId,
    })
    .from(schema.leads)
        ...
        <div className="flex flex-col gap-6 lg:flex-row lg:items-start lg:justify-between">
          <div>
            ...
            <p className="mt-3 max-w-3xl text-sm leading-7 text-slate-500">
              View customers assigned to you, their booking activity, latest
              status, and quick WhatsApp follow-up.
            </p>
          </div>
            ...
            >
              <div className="flex flex-col gap-5 xl:flex-row xl:items-start xl:justify-between">
                ...
                <div className="flex shrink-0 flex-wrap gap-2">
                  ...
                  {latestBooking ? (
                    <Link
                      href={`/agent/bookings/${latestBooking.id}`}
