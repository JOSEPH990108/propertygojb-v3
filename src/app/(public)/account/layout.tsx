...
import { CalendarCheck, CalendarClock, LayoutDashboard, MessageSquareText, UserRound } from "lucide-react";
  ...
  return (
    <div className="min-h-[70vh] bg-muted/40">
      <div className="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
        ...
        <nav className="mb-8 flex gap-2 overflow-x-auto pb-2" aria-label="Account navigation">
